...
my %typemap = (
  ...
  "SOCKADDR"   => ["sockaddr", ""],
  "STRING"     => ["stringz", ""],
  "BYTE[20]"   => ["array", "of=uint8, num=20"],
  "BYTE[128]"  => ["array", "of=uint8, num=128"],
  "DWORD[5]"   => ["array", "of=uint32, num=5"],
  "DWORD[8]"   => ["array", "of=uint32, num=8"],
  "DWORD[9]"   => ["array", "of=uint32, num=9"],
  "DWORD[16]"  => ["array", "of=uint32, num=16"],
  "DWORD[21]"  => ["array", "of=uint32, num=21"],
  "DWORD[22]"  => ["array", "of=uint32, num=22"],
