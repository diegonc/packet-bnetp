...
--[[doc
    ...
    Remarks:         Provides you with the proper response to a 0x5E SID_WARDEN packet. If
                     you receive result 0x00, then you should respond to SID_WARDEN with
                     the Data, otherwise you should not respond to the SID_WARDEN packet.
    ...
    Related:         [0x7D] BNLS_WARDEN (C->S), [0x5E] SID_WARDEN (C->S)
...
--[[doc
    ...
    Format:          (STRING) Message from the server

    Remarks:         This packet is not part of the official documentation; however, it was
                     necessary to add it here because it can be seen on some BNLS software
                     such as BNLSWarden. It was created to warn users that their IP has
                     been restricted temporarily, and that they should reconnect later.

                     When you receive this, you will also be disconnected from the server.
                     The server will send this to you immediately after you connect, there
                     is no other way to trigger this packet.

                     In most cases, this packet can be disregarded (or left unrecognized),
                     since the server will still disconnect you and you will still get an
                     error even if you do not recognize or make use of this packet.

                     This packet is useful only if you wish to display the reason why the
                     server disconnected you. Please remember that only certain BNLSs will
                     have this, so you cannot rely on this packet to give you the reason
                     unless you receive it.

]]
[BNLS_IPBAN] = { -- 0xFF
	stringz("Message from the server"),
},
--[[doc
    Message ID:    0x01
...
--[[doc
    ...
    Message Name:    SID_WARCRAFTUNKNOWN
    ...
    Remarks:         Unknown. I am unable to disassemble Warcraft III's game.dll without a
                     lot of trouble, and therefore I have limited knowledge of it. It has
                     been seen once, after SID_LOGONPROOF (0x54) in the NLS logon sequence.
